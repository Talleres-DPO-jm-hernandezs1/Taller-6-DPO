...
public class VentanaPrincipal extends JFrame
{
    ...
    public void mostrarVentanaMapa( )
    {
    	if (ventanaMapa == null || !ventanaMapa.isVisible()) {
    		...
    		List<Restaurante> completo = getRestaurantes(true);
    		ventanaMapa = new VentanaMapa(this, completo);
    ...
    private void actualizarRestaurantes( )
    {
        ...
        pLista.actualizarRestaurantes(todos); // <--- ESTA ES LA LÍNEA QUE FALTABA
        if (!todos.isEmpty()) {
